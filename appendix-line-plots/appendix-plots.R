...
tiff('anxdep.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="anxdep.yn", ylab="Dep/Anx (%)")
dev.off()
tiff('Tel.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="Tel", ylab="Telehealth (%)")
dev.off()
tiff('BT.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="BT", ylab="Behavior Therapy (%)")
dev.off()
tiff('PS.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="PS", ylab="Peer Support (%)")
dev.off()
tiff('TCM.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="TCM", ylab="TCM (%)")
dev.off()
tiff('cost.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Con_Outcomes="cost", Bin_Outcomes = 1, ylab="Median Cost in $1000")
dev.off()
tiff('hospital.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="HOSPITAL", ylab="Hospitalization (%)")
dev.off()
tiff('ER.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="ER", ylab="ER Visit (%)")
dev.off()
tiff('selfharm.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="selfharm.yn", ylab="Self Harm (%)")
dev.off()
tiff('ideation.tiff', width = 19000*.4, height = 11000*.4, res=300)
plot.fun(data, Bin_Outcomes="suicidalideations.yn", ylab="Suicidal Ideation (%)")
dev.off()
tiff('attempt.tiff', width = 19000*.4, height = 11000*.4, res=300)
...
tiff('AUD.tiff', width = 19000*.4, height = 11000*.4, res=300)
